...
#define GPIO_PIN_SET(reg, pin) ((reg) |= (1u << (pin)))
#define GPIO_PIN_CLEAR(reg, pin) ((reg) &= ~(1u << (pin)))
#define GPIO_PIN_READ(reg, pin) (((reg) >> (pin)) & 1u)
#define GPIO_PIN_TOGGLE(reg, pin) ((reg) ^= (1u << (pin)))
