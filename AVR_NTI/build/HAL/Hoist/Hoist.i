...
# 28 "HAL/Hoist/Hoist.c" 3
   (*(volatile uint8_t *)((0x2F) + 0x20)) 
# 28 "HAL/Hoist/Hoist.c"
          = (1U << 
# 28 "HAL/Hoist/Hoist.c" 3
                   7
# 28 "HAL/Hoist/Hoist.c"
...
# 29 "HAL/Hoist/Hoist.c" 3
   (*(volatile uint8_t *)((0x2E) + 0x20)) 
# 29 "HAL/Hoist/Hoist.c"
          = (1U << 
# 29 "HAL/Hoist/Hoist.c" 3
                   4
# 29 "HAL/Hoist/Hoist.c"
...
# 30 "HAL/Hoist/Hoist.c" 3
   (*(volatile uint16_t *)((0x26) + 0x20)) 
# 30 "HAL/Hoist/Hoist.c"
        = 799U;
    
# 31 "HAL/Hoist/Hoist.c" 3
   (*(volatile uint16_t *)((0x2A) + 0x20)) 
# 31 "HAL/Hoist/Hoist.c"
         = 0U;
}
...
# 36 "HAL/Hoist/Hoist.c" 3
   (*(volatile uint16_t *)((0x2A) + 0x20)) 
# 36 "HAL/Hoist/Hoist.c"
         = 0U;
    HST_ApplyBrakeState();
}
...
# 65 "HAL/Hoist/Hoist.c" 3
   (*(volatile uint16_t *)((0x2A) + 0x20)) 
# 65 "HAL/Hoist/Hoist.c"
         = (uint16)compareVal;
}
